...
# 修改成你的训练集目录 写到 /image_scene_training 即可
path = r'D:\chrome_download\image_scene_training_last\image_scene_training'
...
NB_LAYERS_TO_FREEZE = int(175 * .4)  # resnet层数*0.4

train_dir = os.path.join(path, 'train')  # 训练集数据
val_dir = os.path.join(path, 'val')  # 验证集数据
nb_classes = 20
nb_epoch = 60
batch_size = 72
...
if os.path.exists('my_model_resnet50.h5'):
    # 接着上次的模型进行训练
